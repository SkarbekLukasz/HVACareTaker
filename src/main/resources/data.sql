...
INSERT INTO
    device(id, name, serial_number, model, production_date, producent_id, value, cooling_power, refrigerant_id, refrigerant_mass, localization, category_id, last_control)
VALUES
    (1, 'Agregat chłodniczy Carrier 30KAV', '12345678', '30KAV', '2020-06-25', 1, 500000.00, 580.00, 2, 120, 'podest techniczny', 2, '2022-03-25');
